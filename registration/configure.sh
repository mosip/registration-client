...
then
	...
	wget "${artifactory_url}/artifactory/libs-release-local/mock-sdk/1.1.5/mock-sdk-jar-with-dependencies.jar" -O "${work_dir}"/registration-client/target/lib/mock-sdk-jar-with-dependencies.jar
fi
