...
CREATE TABLE "APP"."RID_SEQ" ("CURR_SEQ_NO" INTEGER NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."TEMPLATE" ("ID" VARCHAR(36) NOT NULL, "NAME" VARCHAR(128) NOT NULL, "DESCR" VARCHAR(256), "FILE_FORMAT_CODE" VARCHAR(36) NOT NULL, "MODEL" VARCHAR(128), "FILE_TXT" CLOB, "MODULE_ID" VARCHAR(36), "MODULE_NAME" VARCHAR(128), "TEMPLATE_TYP_CODE" VARCHAR(36) NOT NULL, "LANG_CODE" VARCHAR(3) NOT NULL, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."KEY_STORE" ("ID" VARCHAR(36) NOT NULL, "PUBLIC_KEY" BLOB(2147483647) NOT NULL, "VALID_FROM_DTIMES" TIMESTAMP NOT NULL, "VALID_TILL_DTIMES" TIMESTAMP NOT NULL, "REF_ID" VARCHAR(64), "STATUS_CODE" VARCHAR(36), "LANG_CODE" VARCHAR(3), "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
INSERT INTO "REG"."GLOBAL_PARAM" VALUES ('mosip.kernel.keymanager-service-validate-url','mosip.kernel.keymanager-service-validate-url','null','CONFIGURATION','eng',true,'SYSTEM',current timestamp, 'SYSTEM',current timestamp, false, current timestamp);