...
public enum RegistrationExceptionConstants {
	...
	REG_BIOMETRIC_SDK_INVALID_SCORE("REG-BQC-003", "Invalid biometric quality score received from SDK"),
	REG_BIOMETRIC_SDK_TIMEOUT("REG-BQC-004", "Biometric quality evaluation timed out. Please re-capture biometrics"),
	REG_BIOMETRIC_NO_QUALITY_SOURCE("REG-BQC-005", "Biometric quality evaluation is not configured. Registration cannot proceed"),
	REG_BIOMETRIC_QUALITY_BELOW_THRESHOLD("REG-BQC-006", "Biometric quality below acceptable threshold. Please re-capture"),
	REG_BIOMETRIC_PARTIAL_CAPTURE("REG-BQC-007", "Incomplete biometric capture. Please capture all required biometrics"),
	REG_BIOMETRIC_CORRUPT_DATA("REG-BQC-008", "Captured biometric data is invalid. Please re-capture"),
	REG_BIOMETRIC_CONFIG_ERROR("REG-BQC-009", "Biometric quality configuration error. Please contact administrator"),
	REG_BIOMETRIC_AUDIT_LOG_FAILURE("REG-BQC-010", "Warning: Unable to record biometric quality audit details"),
	...
	TPM_PUBLIC_KEY_UPLOAD("REG-TPK-001", "Exception verifying TPM Public Keys"),
	...
	REG_MASTER_SYNC_SERVICE_IMPL_NO_MACHINE_NAME("REG-MSS-004","master sync service mandatory machine name is missing."),
