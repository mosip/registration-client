...
CREATE TABLE "REG"."REG_CENTER_MACHINE" ("REGCNTR_ID" VARCHAR(10) NOT NULL, "MACHINE_ID" VARCHAR(10) NOT NULL, "LANG_CODE" VARCHAR(3), "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."USER_DETAIL" ("ID" VARCHAR(36) NOT NULL, "NAME" VARCHAR(64) NOT NULL, "EMAIL" VARCHAR(64), "MOBILE" VARCHAR(16), "STATUS_CODE" VARCHAR(64), "LANG_CODE" VARCHAR(3) NOT NULL, "LAST_LOGIN_DTIMES" TIMESTAMP, "LAST_LOGIN_METHOD" VARCHAR(36), "UNSUCCESSFUL_LOGIN_COUNT" SMALLINT, "USERLOCK_TILL_DTIMES" TIMESTAMP, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP, "REG_ID" VARCHAR(36), "SALT" VARCHAR(64));
...
CREATE TABLE "REG"."TEMPLATE_TYPE" ("CODE" VARCHAR(36) NOT NULL, "DESCR" VARCHAR(256) NOT NULL, "LANG_CODE" VARCHAR(3), "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."VALID_DOCUMENT" ("DOCTYP_CODE" VARCHAR(36) NOT NULL, "DOCCAT_CODE" VARCHAR(36) NOT NULL, "LANG_CODE" VARCHAR(3), "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."TEMPLATE_FILE_FORMAT" ("CODE" VARCHAR(36) NOT NULL, "DESCR" VARCHAR(256) NOT NULL, "LANG_CODE" VARCHAR(3), "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
ALTER TABLE "REG"."TEMPLATE_TYPE" ADD CONSTRAINT "PK_TMPLTYP_CODE" PRIMARY KEY ("CODE");
...
ALTER TABLE "REG"."TEMPLATE_FILE_FORMAT" ADD CONSTRAINT "PK_TFFMT_CODE" PRIMARY KEY ("CODE");
