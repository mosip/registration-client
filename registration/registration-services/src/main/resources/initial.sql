...
CREATE TABLE "REG"."USER_BIOMETRIC" ("USR_ID" VARCHAR(36) NOT NULL, "BMTYP_CODE" VARCHAR(36) NOT NULL, "BMATT_CODE" VARCHAR(36) NOT NULL, "BIR_DATA" BLOB(2147483647), "BIO_ISO_IMAGE" BLOB(2147483647), "BIR_MINOR_VERSION" VARCHAR(8), "BIR_MAJOR_VERSION" VARCHAR(8), "QUALITY_SCORE" INTEGER, "NO_OF_RETRY" SMALLINT, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP, "BIO_MINUTIA" CLOB(2147483647));
