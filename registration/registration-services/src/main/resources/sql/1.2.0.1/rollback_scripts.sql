...
RENAME TABLE "REG"."BLOCKLISTED_WORDS" TO "BLACKLISTED_WORDS";
...
ALTER TABLE "REG"."USER_BIOMETRIC" DROP COLUMN "BIR_MINOR_VERSION";
ALTER TABLE "REG"."USER_BIOMETRIC" DROP COLUMN "BIR_MAJOR_VERSION";
RENAME COLUMN "REG"."USER_BIOMETRIC".BIR_DATA TO BIO_RAW_IMAGE;
