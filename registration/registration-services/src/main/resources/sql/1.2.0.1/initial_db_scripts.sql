...
ALTER TABLE "REG"."USER_BIOMETRIC" ADD COLUMN "BIR_MINOR_VERSION" VARCHAR(8);
ALTER TABLE "REG"."USER_BIOMETRIC" ADD COLUMN "BIR_MAJOR_VERSION" VARCHAR(8);
RENAME COLUMN "REG"."USER_BIOMETRIC".BIO_RAW_IMAGE TO BIR_DATA;
