...
MERGE INTO "REG"."GLOBAL_PARAM" gp1 USING "SYSIBM"."SYSDUMMY1" ON gp1.code = 'mosip.registration.audit_timestamp' WHEN NOT MATCHED THEN INSERT VALUES ('mosip.registration.audit_timestamp','mosip.registration.audit_timestamp',null,'CONFIGURATION','eng',true,'SYSTEM',current timestamp, 'SYSTEM',current timestamp, false, current timestamp);
