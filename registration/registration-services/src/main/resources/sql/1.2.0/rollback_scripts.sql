...
DROP TABLE IF EXISTS "REG"."PROCESS_SPEC" CASCADE;
DROP CONSTRAINT IF EXISTS "PK_PROCSPEC_TYPE";
DROP CONSTRAINT IF EXISTS "UK_PROCSPEC_ID";

DROP TABLE IF EXISTS "REG"."FILE_SIGNATURE" CASCADE;
...
DROP CONSTRAINT IF EXISTS "UK_CERT_THUMBPRINT";
DROP CONSTRAINT IF EXISTS "UK_UNI_IDENT";
