...
import registrationtest.pojo.schema.ProcessSchema;
...
public class DemographicPage {
            ...
            public void run() {
                ...
                try {
                    ...
                    assertNotNull(demoTextFieldvar, id+" not present");
                        ...
                        {
                            String makeUniqueEntry=PropertiesUtil.getKeyValue("makeUniqueEntry");//full@@add
                            
                            Boolean appendDateTime=makeUniqueEntry==null ? false : makeUniqueEntry.contains(id1.replace("#", ""));
                            // appendDateTime = Arrays.asList(makeUniqueEntry).stream().anyMatch(uniqueid->uniqueid.equals(id));
    ...
    public WebViewDocument screensFlow(String JsonIdentity,String flow,String ageGroup)  {
        ...
        try {
            ...
            //rootSchema = JsonUtil.convertJsonintoJava(getSchemaJsonTxt(), Root.class);
            // processSchema = JsonUtil.convertJsonintoJava(jsonFromSchema, ProcessSchema.class);
            processSchema = JsonUtil.convertJsonintoJava(jsonFromSchema, Root.class);

            //logger.info(rootSchema.getIdVersion());
        ...
        {	
            ...
            for(Schema schema: fieldsList)
            {
                try {
                    ...
                    logger.info("Automaiton Script - id="+ "=" +schema.getId() + "\tSchemaControlType=" + schema.getControlType());
    ...
    public void getTextboxKeyValueUpdate(Schema schema,String id,String JsonIdentity,String key,Boolean trans,String scenario,String ageGroup)
    {	
    ...
    public void getTextboxKeyValueChild1(Schema schema,String id,String JsonIdentity,String key,Boolean trans,String scenario)
    {
    ...
    public void getTextboxKeyValueChild(Schema schema,String id,String JsonIdentity,String key,Boolean trans,String scenario)
    {
        logger.info("Schema Control Type textbox");
        mapValue=null;
        ...
        try {
             ...
             mapDropValue=null;
                ...
                if(!text.isEmpty())
                {
                    ...
                    Optional<Node> opNode=hbox.getChildren().stream().filter(node -> (node instanceof Button) && ((Button)node).getText().equalsIgnoreCase(text)).findFirst();
                    if(opNode.isPresent())
                    {
