...
public class BiometricUploadPage {
	...
	String IRIS_DOUBLE="#individualBiometricsIRIS_DOUBLE";
	String FINGERPRINT_SLAB_RIGHT="#individualBiometricsFINGERPRINT_SLAB_RIGHT";
	String FINGERPRINT_SLAB_LEFT="#individualBiometricsFINGERPRINT_SLAB_LEFT";
	String FINGERPRINT_SLAB_THUMBS="#individualBiometricsFINGERPRINT_SLAB_THUMBS";
	String FACE="#individualBiometricsFACE";
	String EXCEPTION_PHOTO="individualBiometricsEXCEPTION_PHOTO";
	 ...
	 * @throws IOException
	 */
	public void newRegbioUpload(List<String> list)  {
		try
		{
