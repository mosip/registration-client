...
private static final Logger logger = LogManager.getLogger(ExtentReportUtil.class); 
	  ...
	  public static Path REPORTPATH=Paths.get(System.getProperty("user.dir"),"Report","extentReport"+DateUtil.getDateTime()+".html");
	  
	 // System.getProperty("user.dir") +"\\Report\\extentReport"+DateUtil.getDateTime()+".html";
